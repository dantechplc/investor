...
from accounts.models import Client, User, Account, CompanyProfile
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            user = form.save(commit=False)
             # Set the user password and additional fields
            ...
            email.attach_alternative(message, 'text/html')
                # Define images with their CID names
            images = {
                "logo": os.path.join("static/email/images/ctg-logo-1.png"),
            ...
            sweetify.success(request, 'Success!',
                             text=f'Your verification link has been sent to your email.'
                                  f' Please click on the link to activate your email.',
                             button='OK',
                             timer=10000,
